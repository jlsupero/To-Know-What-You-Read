...
description: 本 skill 以人类脑科学博士与心理学博士的专业视角，运用「概念-例子-分析-总结」（CEAS）方法论，帮助用户快速理解书籍与阅读内容的核心知识，构建从感知到认知的自上而下学习模式。当用户要求拆解/讲解书本概念、分析阅读内容、生成读书笔记或深度理解所学知识时，应使用本 skill。
---
